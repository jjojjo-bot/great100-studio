...
Work 제작안은 `Scene 1` 형식뿐 아니라 `장면 | 시간 | 해당 내레이션 | 화면 구성과 이미지 생성 프롬프트` 마크다운 표도 읽습니다. 표에서는 장면별 시간·프롬프트·내레이션 자막을 자동으로 가져옵니다. 이미 만든 프로젝트는 **파싱 확인 → 원문 다시 분석**으로 다시 읽을 수 있습니다.
